...
##Step 1: outcome variables: loan_status, reconstruction
...
##########################################################
###Column Operations
##Step 3: seperate factors and num
str(data2)
...
##desc <- as.numeric(str_length(factors$desc)) 
##factors$desc <- NULL
...
#numbers <- data.frame(numbers, desc)
...
# measure the association between numericals and outcome, drop numericals not so correlated
